...
As part of the sign up process, users have to play the Reverse Captcha mode until \todo{condition}. This serves the same purpose as \textit{Captcha}, i.e. to keep out bots. This is a type of worker screening as described in \cite{oleson2011programmatic}.
